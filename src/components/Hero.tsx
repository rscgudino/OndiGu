...
export const Hero: React.FC<HeroProps> = ({ onQuoteClick, onPortfolioClick }) => {
  return (
    <section
      id="hero"
      className="relative min-h-[90vh] pt-32 pb-20 md:pt-40 md:pb-28 flex flex-col justify-center items-center text-center px-4 sm:px-6 lg:px-8 overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
        ...
        {/* CTAs (No arrows attached per strict guidelines) */}
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto">
          <button
            id="hero-primary-quote-cta"
            type="button"
            onClick={onQuoteClick}
            className="w-full sm:w-auto px-8 py-4 text-base font-semibold text-white bg-[#FF4500] hover:bg-[#e03d00] rounded shadow-[0_0_30px_rgba(255,69,0,0.35)] transition-all duration-200 active:scale-[0.98]"
          >
            Pedí tu presupuesto
          </button>
          ...
          <button
            ...
            className="w-full sm:w-auto px-7 py-4 text-base font-medium text-[#e0e0e0] hover:text-white bg-[#181a22] hover:bg-[#20232e] border border-[#2a2e3b] hover:border-[#3c4254] rounded transition-all duration-200"
          >
            Ver portfolio
          </button>
        </div>
