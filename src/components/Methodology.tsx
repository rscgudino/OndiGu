...
export const Methodology: React.FC = () => {
  ...
  return (
    <section id="metodologia" className="py-24 px-4 sm:px-6 lg:px-8 bg-[#0f1218] border-t border-[#1e222e]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          {METHODOLOGY_STEPS.map((step, idx) => {
            ...
            return (
              <div
                key={step.number}
                className="relative bg-[#151821] border border-[#232734] p-8 flex flex-col justify-between"
              >
                <div>
                  ...
                  <div className="flex items-center justify-between mb-8 pb-4 border-b border-[#202430]">
                    ...
                    <div className="w-8 h-8 flex items-center justify-center bg-[#1d202c] text-[#FF8C00] rounded">
                ...
                <div className="pt-6 border-t border-[#202430] space-y-3">
                  <div>
                    <span className="block text-[11px] font-semibold text-[#FF8C00] uppercase tracking-wide mb-1">
                      Lo que recibís
                    </span>
                    <p className="text-xs sm:text-sm text-[#d4d4d4] leading-normal font-normal">
                      {step.clientDeliverable}
                    </p>
                  </div>

                  <div className="pt-2 text-[11px] text-[#707070] font-mono">
                    Tiempo estimado: <span className="text-[#a0a0a0] font-medium">{step.durationEstimate}</span>
                  </div>
                </div>
              </div>
            );
