  ...
  return (
    <section id="servicios" className="py-12 sm:py-18 lg:py-24 px-3.5 sm:px-6 lg:px-8 bg-[#0c0e12] border-t border-[#1a1d26]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 sm:mb-12 pb-5 border-b border-[#202430] gap-3 sm:gap-4">
        ...
        {/* Responsive Grid Layout: Bento architecture with rock-solid mobile stacking */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-5 lg:gap-6">
          ...
          >
            ...
            <div>
              {/* Top Meta Bar: Icon + Category + Badge */}
              <div className="flex items-center justify-between gap-2 mb-3.5 sm:mb-4">
                ...
                <span className="inline-flex items-center gap-1.5 px-2.5 py-1 text-[10px] sm:text-[11px] font-mono text-[#FF8C00] bg-[#FF8C00]/10 border border-[#FF8C00]/30 rounded-md shrink-0 whitespace-nowrap">
              ...
              {/* Title */}
              <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white tracking-tight mb-3">
                Desarrollo Web
              </h3>
              ...
              {/* Technical Mini Preview Bar - Mobile resilient chips */}
            ...
            {/* Action Bar */}
            <div className="pt-3.5 sm:pt-4 border-t border-[#1e2332] flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          >
            ...
            <div>
              ...
              <div className="flex items-center justify-between gap-2 mb-3.5 sm:mb-4">
                ...
                <div className="flex items-center gap-1 px-2.5 py-1 text-[10px] sm:text-[11px] font-mono text-emerald-400 bg-emerald-950/40 border border-emerald-800/40 rounded-md shrink-0 whitespace-nowrap">
          ...
          >
            ...
            <div>
              <div className="flex items-center justify-between gap-2 mb-3">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-[#1c202e] border border-[#2b3145] flex items-center justify-center text-[#FF4500] group-hover:scale-105 transition-transform">
                  <Zap className="w-4 h-4 sm:w-5 sm:h-5" />
                </div>
                <span className="text-[10px] sm:text-[11px] font-mono uppercase tracking-wider text-[#9ba2b5] font-semibold">
              ...
              {/* Visual mini-flow - 100% Mobile Resilient */}
          ...
          >
            ...
            <div>
              <div className="flex items-center justify-between gap-2 mb-3">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-[#1c202e] border border-[#2b3145] flex items-center justify-center text-[#FF8C00] group-hover:scale-105 transition-transform">
          ...
          {/* 6. TECNOLOGÍA E INFRAESTRUCTURA - Mobile-First Solid Layout */}
          <div 
          ...
          >
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-5 sm:gap-6">
              ...
              <div className="flex flex-col sm:flex-row sm:items-start gap-3.5 sm:gap-5">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-[#1a1d2b] border border-[#292f44] flex items-center justify-center text-[#FF4500] shrink-0">
                  <Server className="w-5 h-5 sm:w-6 sm:h-6" />
                </div>
                <div>
                  <div className="flex flex-wrap items-center gap-2 mb-1.5">
                    <span className="text-[10px] sm:text-[11px] font-mono uppercase tracking-wider text-[#FF8C00] font-semibold">
